...
<div class="container mt-5">
    ...
    <?php if ($message): ?>
        <div class="alert alert-info" style="background-color: <?php echo $toastClass; ?>; color: white;">
            <?php echo $message; ?>
        </div>
    <?php endif; ?>
